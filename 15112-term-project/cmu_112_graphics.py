...
print('Using a modified version of cmu graphics')
...
class App(object):
    ...
    def getSnapshot(app):
        ...
        #result = app.getSnapshotHelper(x0,y0,x0+app.width,y0+app.height)
        return result

    def getSnapshotHelper(app, left, top, right, bottom):
        with mss.mss() as sct:
            ...
            sct_img = sct.grab(bbox)  # type: ignore
            # Save it!
